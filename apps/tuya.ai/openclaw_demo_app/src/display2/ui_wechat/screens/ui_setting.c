...
void ui_setting_screen_init(void)
{
    ...
    ui_object_set_themeable_style_property(ui_setting_status_label, LV_PART_MAIN | LV_STATE_DEFAULT,
    ...
    ui_object_set_themeable_style_property(ui_setting_volume_label, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_TEXT_COLOR, _ui_theme_color_PrimaryText);
    ...
    if (lv_slider_get_mode(ui_setting_volume_slider) == LV_SLIDER_MODE_RANGE)
        lv_slider_set_left_value(ui_setting_volume_slider, 0, LV_ANIM_OFF);
    ...
    if (lv_obj_get_style_pad_top(ui_setting_volume_slider, LV_PART_MAIN) > 0)
        lv_obj_set_style_pad_right(ui_setting_volume_slider,
                                   lv_obj_get_style_pad_right(ui_setting_volume_slider, LV_PART_MAIN) + 1,
                                   LV_PART_MAIN);
    ...
    lv_obj_set_flex_align(ui_setting_brightness_container, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_CENTER,
                          LV_FLEX_ALIGN_START);
    ...
    if (lv_slider_get_mode(ui_setting_brightness_slider) == LV_SLIDER_MODE_RANGE)
        lv_slider_set_left_value(ui_setting_brightness_slider, 0, LV_ANIM_OFF);
    ...
    // Compensating for LVGL9.1 draw crash with bar/slider max value when top-padding is nonzero and right-padding is 0
    if (lv_obj_get_style_pad_top(ui_setting_brightness_slider, LV_PART_MAIN) > 0)
        lv_obj_set_style_pad_right(ui_setting_brightness_slider,
                                   lv_obj_get_style_pad_right(ui_setting_brightness_slider, LV_PART_MAIN) + 1,
                                   LV_PART_MAIN);
