...
void ui_setting_screen_init(void)
{
    ...
    lv_obj_set_flex_align(ui_time_date_container, LV_FLEX_ALIGN_SPACE_EVENLY, LV_FLEX_ALIGN_START,
    ...
    lv_obj_set_flex_align(ui_dev_status_container2, LV_FLEX_ALIGN_SPACE_AROUND, LV_FLEX_ALIGN_START,
                          LV_FLEX_ALIGN_CENTER);
    ...
    if (lv_slider_get_mode(ui_volume_slider) == LV_SLIDER_MODE_RANGE)
        lv_slider_set_left_value(ui_volume_slider, 50, LV_ANIM_OFF);
    ...
    if (lv_obj_get_style_pad_top(ui_volume_slider, LV_PART_MAIN) > 0)
        lv_obj_set_style_pad_right(ui_volume_slider, lv_obj_get_style_pad_right(ui_volume_slider, LV_PART_MAIN) + 1,
                                   LV_PART_MAIN);
