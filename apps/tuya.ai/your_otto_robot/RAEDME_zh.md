...
3. **显示屏**
    - 型号：ST7789 （更大性能更好）/ Otto 鸭子外壳 双眼用的0.96寸160*80 ST7735S屏幕  （两个小眼睛只做表情）
    - 购买渠道：淘宝
...
一句话解释： 设备通电开机并进入配网模式后，通过手机上的“涂鸦智能 App”将你家的 Wi-Fi 账号密码通过蓝牙或 AP 模式下发给设备。

代码行： （纯手机端 UI 操作，设备侧终端通常会打印类似 WIFI config mode started 的配网状态日志）

设备调试 (Device Debugging)
设备名/目标对象： T3 / T5AI 高性能芯片
